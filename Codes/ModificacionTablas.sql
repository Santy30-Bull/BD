...
BEGIN
    ...
    -- Iterar sobre cada calificaci�n afectada por la operaci�n de inserci�n o actualizaci�n
    ...
    BEGIN
        ...
        -- Verificar si alguna nota est� fuera del rango permitido para el estudiante actual
        IF EXISTS (
            SELECT 1
            FROM inserted AS C
